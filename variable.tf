...
variable "RS_release" {
  default =  "https://s3.amazonaws.com/redis-enterprise-software-downloads/8.0.10/redislabs-8.0.10-76-jammy-amd64.tar"
...
// Redis Flex / Redis on Flash disk count to create and mount SSD NVMe disk
